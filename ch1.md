...
### <span style="color:#6c9ef0" /> **飞船舰长职责 1：计算给发动机提供多少能量**
...
### <span style="color:#6c9ef0" />**飞船舰长职责 2: 计算目的地**
...
### <span style="color:#6c9ef0" /> **飞船舰长职责 3: 发动机故障检测（初级）**
